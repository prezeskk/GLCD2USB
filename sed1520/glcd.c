...
// draw line
void
glcdLine(void (*draw) (u08, u08), u08 x1, u08 y1, u08 x2, u08 y2)
{
	int dx, dy, inx, iny, e;
...
// draw rectangle
void
glcdRectangle(u08 x, u08 y, u08 a, u08 b)
{
	unsigned char j;
...
// draw circle
void
glcdCircle(u08 xcenter, u08 ycenter, u08 radius)
{
	int tswitch, y, x = 0;
	unsigned char d;
...
void
glcdWriteChar(unsigned char c)
{
	u08 i = 0;
	c -= 0x20;

	for (i = 0; i < 5; i++) {
		glcdDataWrite(pgm_read_byte(Font5x7 + (c * 5) + i));
	}
